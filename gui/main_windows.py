"""Janela principal da aplicação SuporteTools."""
...
from .computer_tab import ComputerTabMixin
from .helpers import SystemInfoBase, _ensure_admin
from .network_tab import NetworkTabMixin
from .printer_tab import PrinterTabMixin
from .program_tab import ProgramTabMixin
from .styles import setup_styles

class SystemInfoApp(
    ComputerTabMixin, ProgramTabMixin, NetworkTabMixin, PrinterTabMixin, SystemInfoBase
):
    """Orquestra a janela e as quatro abas da aplicação."""
    ...
    def __init__(self, root: tk.Tk) -> None:
        ...
        setup_styles(ttk.Style(self.root))
        super().__init__(root)
        self._build_ui()

    def _configure_styles(self) -> None:
        """Compatibilidade para chamadas legadas que configuravam o tema."""
        setup_styles(ttk.Style(self.root))

    def _build_ui(self) -> None:
        """Monta o menu inicial e as telas das quatro abas."""
...
def _log_program_end(root: tk.Tk) -> None:
    from modules.security import log_audit

    log_audit("program_end", "Programa encerrado")
...
def main() -> None:
    ...
    root.protocol(
        "WM_DELETE_WINDOW",
        lambda: (_log_program_end(root), root.destroy()),
    )
    SystemInfoApp(root)
    root.mainloop()
